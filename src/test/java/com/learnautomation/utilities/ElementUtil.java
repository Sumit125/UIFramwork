...
public class ElementUtil {
	...
	private JavascriptExecutor jsUtil;

	public ElementUtil(WebDriver driver) {
		this.driver = driver;
		//jsUtil = new JavascriptExecutor(driver);
	}

	/*
	 * public By getBy(String locatorType, String locatorValue) { By locator = null;
	 * switch (locatorType.toLowerCase()) { case "id": locator =
	 * By.id(locatorValue); break; case "name": locator = By.name(locatorValue);
	 * break; case "classname": locator = By.className(locatorValue); break; case
	 * "xpath": locator = By.xpath(locatorValue); break; case "css": locator =
	 * By.cssSelector(locatorValue); break; case "linktext": locator =
	 * By.linkText(locatorValue); break; case "partiallinktext": locator =
	 * By.partialLinkText(locatorValue); break; case "tagname": locator =
	 * By.tagName(locatorValue); break;
	 * 
	 * default: break; }
	 * 
	 * return locator; }
